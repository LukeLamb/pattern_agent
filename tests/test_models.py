...
class TestPattern:
    ...
    def test_pattern_price_targets(self):
        ...
        support_levels = [SupportResistanceLevel(price=100.0, touches=3, strength=0.8)]
...
class TestTradingSignal:
    ...
    def test_signal_creation(self):
        ...
        target_prices = TargetPrices(
            primary_target=110.0, secondary_target=115.0, stop_loss=95.0
        )
    ...
    def test_signal_risk_reward(self):
        ...
        signal = TradingSignal(
            ...
            target_prices=TargetPrices(
                primary_target=90.0, secondary_target=85.0, stop_loss=105.0
            ),
